...
// Cuando el movimiento es un ingreso se muestra la imagen iconIngreso.png y cuando es un egreso se muestra la imagen iconEgreso.png
...
const columns = [
  ...
  { title: 'Movimiento', field: 'movimiento', width: 150, height: 100, formatter: egresos },
...
class Balance extends Component {
  ...
  render() {
    ...
    return ( 
    <div className="animated fadeIn containerBalance" id="balance">
      <Title title="Balance"/>
      <Container className="movimientos">
        ...
        <CustomRow className="m-top-30">
          ...
          <CustomCol xs="12" md="6" className="bgForm">
            <CustomRow>
        ...
        <CustomRow><CustomCol><div className="wrap-chart-estadistic"><RecordChart/></div></CustomCol></CustomRow>
        <div className="espacio2"></div>
        {/* MOVIMIENTOS */}
        <h4>Historial</h4>
        <Row>
