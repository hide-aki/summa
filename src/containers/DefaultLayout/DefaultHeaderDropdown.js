  ...
  dropAccnt() {
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        ...
        <DropdownMenu right>
          {/* <DropdownItem header tag="div" className="text-center"><strong>Usuarios</strong></DropdownItem>
          <DropdownItem>Miranda<Badge color="info">42</Badge></DropdownItem>
          <DropdownItem>Yohan<Badge color="success">42</Badge></DropdownItem>
          <DropdownItem active>Leafar<Badge color="danger">42</Badge></DropdownItem>
          <DropdownItem>Vivi<Badge color="warning">42</Badge></DropdownItem>
          <DropdownItem>Manuel<Badge color="warning">42</Badge></DropdownItem> */}
          <DropdownItem>Manuel<Badge color="warning">42</Badge></DropdownItem> 
          <DropdownItem header tag="div" className="text-center"> &nbsp;&nbsp;<Badge color="dark">v.1.0.0</Badge></DropdownItem>
